...
import com.abac.planet.bm.constraints.validators.UniquePlanetValidatorById;
...
@Documented
@Constraint(validatedBy = {UniquePlanetValidatorById.class,})
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.FIELD, ElementType.PARAMETER, })
public @interface UniquePlanetConstraintById {
